/* Service worker — Compra Planejada.
   Assets têm hash no nome (o Vite gera), então o cache pode ser mais
   agressivo: um arquivo com hash nunca muda de conteúdo. Só o index.html
   precisa da estratégia "rede primeiro". */
const CACHE = 'compra-planejada-v1';
const NEVER_CACHE = [
